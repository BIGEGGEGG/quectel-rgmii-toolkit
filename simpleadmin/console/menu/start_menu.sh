...
toolkit_menu() {
    while true; do
        ...
        case "$option" in
            1) cd /tmp && wget -O RMxxx_rgmii_toolkit.sh https://raw.gitmirror.com/SunyWait/quectel-rgmii-toolkit/main/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh && cd / ;;
            2) cd /tmp && wget -O RMxxx_rgmii_toolkit.sh https://raw.gitmirror.com/SunyWait/quectel-rgmii-toolkit/development/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh && cd / ;;
            3) break ;;
...
settings_menu() {
    while true; do
        display_random_color "Welcome to" && display_green "SunyWait's" && display_random_color "Simple Console Menu"
        display_green "Select an option:"
        echo "------------------"
...
main_menu() {
    while true; do
        display_green "Welcome to SunyWait's Simple Console Menu"
