...
install_update_at_socat() {
    ...
    wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/socat-at-bridge/socat-armel-static
    wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/socat-at-bridge/killsmd7bridge
    wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/socat-at-bridge/atcmd
    cd $SOCAT_AT_SYSD_DIR
    wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/socat-at-bridge/systemd_units/socat-smd11.service
    wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/socat-at-bridge/systemd_units/socat-smd11-from-ttyIN.service
    wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/socat-at-bridge/systemd_units/socat-smd11-to-ttyIN.service
    wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/socat-at-bridge/systemd_units/socat-killsmd7bridge.service	
    wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/socat-at-bridge/systemd_units/socat-smd7-from-ttyIN2.service
    wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/socat-at-bridge/systemd_units/socat-smd7-to-ttyIN2.service
    wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/socat-at-bridge/systemd_units/socat-smd7.service
...
install_simple_firewall() {
    ...
    wget -O "$SIMPLE_FIREWALL_DIR/simplefirewall.sh" https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simplefirewall/simplefirewall.sh
    wget -O "$SIMPLE_FIREWALL_DIR/ttl-override" https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simplefirewall/ttl-override
    wget -O "$SIMPLE_FIREWALL_DIR/ttlvalue" https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simplefirewall/ttlvalue
    chmod +x "$SIMPLE_FIREWALL_DIR/simplefirewall.sh"
    chmod +x "$SIMPLE_FIREWALL_DIR/ttl-override"	
    wget -O "$SIMPLE_FIREWALL_SYSTEMD_DIR/simplefirewall.service" https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simplefirewall/systemd/simplefirewall.service
    wget -O "$SIMPLE_FIREWALL_SYSTEMD_DIR/ttl-override.service" https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simplefirewall/systemd/ttl-override.service
		...
		mkdir $SIMPLE_ADMIN_DIR/www/cgi-bin
  		mkdir $SIMPLE_ADMIN_DIR/www/css
    		mkdir $SIMPLE_ADMIN_DIR/www/js
                ...
                wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/systemd/simpleadmin_generate_status.service
		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/systemd/simpleadmin_httpd.service
  		sleep 1
  		cd $SIMPLE_ADMIN_DIR/scripts
  		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/scripts/build_modem_status
    		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/scripts/modemstatus_parse.sh
      		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/scripts/tojson.sh
		sleep 1
		cd $SIMPLE_ADMIN_DIR/www
		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/atcommander.html
  		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/index.html
    		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/speedtest.html
      		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/styles.css
		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/ttl.html
  		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/bandlock.html
  		sleep 1
  		cd $SIMPLE_ADMIN_DIR/www/js
  		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/js/alpinejs.min.js
    		sleep 1
    		cd $SIMPLE_ADMIN_DIR/www/css
    		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/css/admin.css
      		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/css/bulma.css
		sleep 1
		cd $SIMPLE_ADMIN_DIR/www/cgi-bin
		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/cgi-bin/get_atcommand
  		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/cgi-bin/get_csq
    		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/cgi-bin/get_ttl_status
      		wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/simpleadmin/www/cgi-bin/set_ttl
		sleep 1
  		cd /
	...
	rm -rf /usrdata/tailscale_1.62.1_arm
    	echo "Downloading systemd files..."
     	cd $TAILSCALE_SYSD_DIR
      	wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/tailscale/systemd/tailscaled.service
       	wget https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/tailscale/systemd/tailscaled.defaults
	sleep 2s
...
configure_tailscale() {
	...
	wget -O tailscale-webui.service https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/tailscale/systemd/tailscale-webui.service
  	wget -O tailscale-webui-trigger.service https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/old/tailscale/systemd/tailscale-webui-trigger.service
...
install_ttyd() {
    ...
    wget -O scripts/ttyd.bash "https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/ttyd/scripts/ttyd.bash" && chmod +x scripts/ttyd.bash
    wget -O systemd/ttyd.service "https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/ttyd/systemd/ttyd.service"
...
116) 
	    echo -e "\e[1;32mInstalling Entware/OPKG\e[0m"
	    cd /tmp && wget -O installentware.sh https://raw.githubusercontentS.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/installentware.sh && chmod +x installentware.sh && ./installentware.sh && cd /
            ;;
117)  
 	    install_ttyd
      	    ;;
